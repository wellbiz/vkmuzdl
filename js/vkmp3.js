$('body > div').eq(0).parent().append('<style>div.get_it_btn {position: absolute; background: #FFF; z-index: 500; display: none; height: 16px; padding-left: 3px; padding-right: 3px;} div.get_it_btn:hover{background-color: #EDF1F5;} div.det_it_btn a{color: #2B587A}</style>');
